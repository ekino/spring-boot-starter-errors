...
dependencies {
  ...
  implementation("gradle.plugin.com.ekino.oss.plugin:kotlin-quality-plugin:3.1.0") // required by id("com.ekino.oss.plugin.kotlin-quality")
  implementation("org.jetbrains.dokka:dokka-gradle-plugin:1.5.31") // required by id("org.jetbrains.dokka")
